...
const edgeRoutes = [];
const nodeRoutes = [];
function createRouteDefinitions(rewrites, redirects) {
    const extraRoutes = [];
    ...
    function addRouteToRouteTypes(route) {
        ...
        compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation)=>{
            compilation.hooks.processAssets.tapAsync({
                ...
                if (this.typedRoutes) {
                    ...
                    assets[assetPath] = new _webpack.sources.RawSource(createRouteDefinitions(this.originalRewrites, this.originalRedirects));
                }
                callback();
            });
        });
